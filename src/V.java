...
public class V { // V stands for Variables
    ...
    static final String VERSION = "alpha 3.0.0";
    ...
    static Music music = new Music(new String[]{"./src/Music/FireRed/01 Opening.wav", "./src/Music/FireRed/15 Battle (Vs Trainer).wav"});
